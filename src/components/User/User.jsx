    ...
    return (
      <div className={`${styles.container} ${flipped ? styles.flipped : ''}`}>
        ...
        <div className={styles.header}>
          ...
          <button className={styles.buttonCat} onClick={() => setSendMode('cat')} disabled={sentCat}>Enviar 🐱</button>
          <button className={styles.buttonCat} onClick={() => setSendMode('flip')} disabled={sentFlip}>Girar 🔄</button>
          <button className={styles.buttonCat} onClick={() => setSendMode('hide')} disabled={sentHide}>Esconder 🙈</button>
      ...
      <BingoCard card={card} onSelect={selectNumber} />
          </div>
    </div>)
}
